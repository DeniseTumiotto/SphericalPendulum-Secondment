...
s0(1,:) = cart2sph(y1(1,1), y1(2,1), y1(3,1));
s0(2,:) = cart2sph(y2(1,1), y2(2,1), y2(3,1));
...
for k = 1:nTime
    plot3(y1(1,k),y1(2,k),y1(3,k), 'x', 'MarkerSize', 3, ...
    'MarkerFaceColor', 'green', ...
    'MarkerEdgeColor', 'none')
    plot3(y2(1,k),y2(2,k),y2(3,k), 'x', 'MarkerSize', 3, ...
    'MarkerFaceColor', 'blue', ...
    'MarkerEdgeColor', 'none')
end
